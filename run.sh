...
function generate-project {
    ...
    git add --all
    git branch -M main
    git commit -m "feat: generated sample project with python-package-generator"
}
...
EOF
    ...
    git commit -m 'feat!: populated from `python-package-generator` template'
    ...
    gh pr create \
        --title "feat: populated from \`python-package-generator\` template" \
        --body "This PR was generated by \`python-package-generator\`" \
        --base main \
